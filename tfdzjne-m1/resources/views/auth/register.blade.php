            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="rules" class="col-md-4 col-form-label text-md-end">{{ __('Согласие на обработку персональных данных') }}</label>

                            <div class="col-md-6">
                                <input id="rules" type="checkbox" class="@error('rules') is-invalid @enderror" name="rules" value="{{ old('rules') }}" required>
